...
func ANSIColor(code int, text string) string {
	if !colorsEnabled {
		return text
	}
...
func Faint(text string) string {
	return ANSIColor(ColorGray, text)
}
...
func Success(msg string) string {
	return ANSIColor(ColorGreen, "ok") + " " + msg
}

func Error(msg string) string {
	return ANSIColor(ColorRed, "error") + " " + msg
}

func Warning(msg string) string {
	return ANSIColor(ColorYellow, "warning") + " " + msg
}

func Info(msg string) string {
	return ANSIColor(ColorBlue, "info") + " " + msg
}
